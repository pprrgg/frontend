...
const Doc = forwardRef((props, ref) => {
  ...
  const [apiDisponible, setApiDisponible] = useState(null); // null = aún verificando
  const [textoActual, setTextoActual] = useState("Conectando al servidor, por favor espere...");
    ...
    return (
      <Box display="flex" justifyContent="center" alignItems="center" height="100vh">
        <Typography color="error">
          No se encontró ninguna ficha seleccionada. Regrese al catálogo y elija un documento.
        </Typography>
      </Box>
    );
  }
  ...
  // 🔹 función única para obtener PDF desde API o fallback local
  ...
  const renderPdfWithPdfJs = useCallback(async (pdfData) => {
    ...
    try {
      ...
      const marginLeft = 70, marginRight = 70, marginTop = 50, marginBottom = 50;
  ...
  // 🔹 descarga usando la misma función
  ...
  return (
    <>
      ...
      {apiDisponible === null && (
        <Typography align="center">Verificando disponibilidad de la API...</Typography>
      )}
