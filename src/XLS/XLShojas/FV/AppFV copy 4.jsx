            ...
            return (
              <Paper
                ...
                sx={{
                  ...
                  borderRadius: 4,
                  cursor: 'pointer',
                  // --- TRANSPARENCIA Y ALTURA ---
                  bgcolor: isSelected
                    ? 'rgba(255, 165, 0, 0.85)'
                    : 'rgba(255, 255, 255, 0.25)', // Mucho más transparente
                  color: isSelected ? 'white' : '#1a237e',
                  backdropFilter: 'blur(6px)', // Desenfoque un poco más marcado
                  border: isSelected
                    ? '1px solid rgba(255, 255, 255, 0.3)'
                    : '1px solid rgba(255, 255, 255, 0.1)',
                  width: 'fit-content',
                  height: 20, // Altura ultra compacta
                  // ------------------------------
                  overflow: 'hidden',
              ...
              >
                ...
                <Stack
                  ...
                  sx={{
                    ...
                    alignItems: 'center',
                    lineHeight: 1,
                    opacity: isSelected ? 1 : 0.7 // Atenuado si no está activo
                  }}
                >
