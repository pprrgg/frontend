...
const handleAddNew = useCallback(() => {
  ...
  const n = {
    ...
    rotation: 0,
    config: {
      // --- VALORES POR DEFECTO PARA PANEL ---
      modelo: "JKM540M-72HL4-V",  // Modelo típico
      potenciaW: 540,            // Potencia en Wp
      width: 1.134,              // Ancho en metros
      height: 2.278,             // Alto en metros
      
      // --- VALORES POR DEFECTO PARA ESTRUCTURA ---
      tipoEstructura: "coplanar",
      tilt: 30,                  // Inclinación en grados
      slope: 0,                  // Pendiente del suelo
      orientation: "vertical",
      rows: 1,
      cols: 1,
      
      // --- VALORES POR DEFECTO PARA INVERSOR ---
      inverterModel: "Huawei SUN2000-15KTL-M0",
      inverterPower: 15000,      // Potencia en W
      FVcost: 1000,               // Coste EUR por kWp
      mpptCount: 2,              // Número de MPPT
      
      // --- VALORES ELÉCTRICOS DEL PANEL (STC) ---
      vOc: 49.8,                 // Tensión en circuito abierto (V)
      vMp: 41.2,                 // Tensión en punto de máxima potencia (V)
      iSc: 13.93,                // Corriente de cortocircuito (A)
      iMp: 13.11,                // Corriente en punto de máxima potencia (A)
      coefVoc: -0.28,            // Coeficiente de temperatura Voc (%/°C)
      
      // --- VALORES ELÉCTRICOS DEL INVERSOR ---
      vMax: 1100,                // Tensión máxima admisible (V)
      vMinMppt: 200,             // Rango MPPT mínimo (V)
      vMaxMppt: 850,             // Rango MPPT máximo (V)
      iMaxInverter: 30,          // Corriente máxima de entrada (A)
      iScMaxInverter: 40         // Corriente máxima de cortocircuito (A)
    },
    
    // Genera una cuadrícula inicial de paneles
    ...
    sombras: Array(16).fill(1)   // Perfil de sombras por defecto
  };
