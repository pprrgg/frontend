...
export const PdfViewerContent = forwardRef(({ sector: propSector, grupo: propGrupo, cod: propCod }, ref) => {
  ...
  useEffect(() => {
    ...
    // Si es una ruta nueva o primera carga
    if (globalLastUrl !== currentFullUrl) {
      globalLastUrl = currentFullUrl;
      
      // Si no tenemos un PDF dinámico previo para esta ruta, 
      // tomamos los datos de la sesión como "ya leídos" para evitar el botón al inicio
      if (!globalCachedBlob) {
