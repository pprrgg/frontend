  ...
  return (
    <div style={cellStyle}>
      <input
        ...
        value={(isNumericValue && displayValue === "0") ? "" : displayValue}
...
const Toolbar = ({
  ...
  return (
    <Box sx={{
      ...
      {/* 1. Header Info (ZONA CLICABLE PARA EL MENÚ) */}
      <Box
      ...
      {/* 2. Controles de Proyecto y Tabs */}
      <Box sx={{
                ...
                {sheetNames.map((name, i) => (
                  <MenuItem
                    ...
                    sx={{
                      ...
                      fontWeight: 900,
                      textTransform: "uppercase",
                      color: isDirty(name.toString()) ? "#d32f2f" : "inherit",
                    }}
                  >
                    {name}
                  </MenuItem>
      ...
      {/* --- EL MENÚ DESPLEGABLE DE INFORMES --- */}
      <Menu
        anchorEl={anchorEl}
        open={isMenuOpen}
